...
export default function NewsletterSection({
  ...
  subtitle = "Tu primera compra merece ser especial. Descubre nuestra colección y nosotros cubrimos el costo del primer envío. A nivel nacional.",
            ...
            <ScrollReveal direction="right" delay={0.3}>
              <div className="relative h-[400px] sm:h-[450px] lg:h-[550px] w-full group perspective-1000 mt-10 lg:mt-0">
                ...
                <div className="absolute -bottom-3 left-4 md:-bottom-4 md:left-8 z-20 bg-white px-3 py-1.5 md:px-4 md:py-2 shadow-lg rounded-sm flex items-center gap-2">
                   <span className="text-[8px] md:text-[10px] font-bold uppercase tracking-widest text-gray-800">Oferta Activa Marzo 2026</span>
                </div>
              </div>
            </ScrollReveal>
          )}
