...
export default function BenefitsGrid() {
    const benefits = [
        ...
        },
        {
            ...
            description: "Tu información está encriptada y segura con nosotros."
        },
        {
            icon: HeartHandshake,
        ...
        <section className="py-24 bg-white border-t border-slate-50">
            <div className="max-w-[1600px] mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {benefits.map((b, i) => (
                        <div key={i} className="flex flex-col items-center text-center p-6 rounded-2xl hover:bg-slate-50 transition-colors duration-300 group">
