...
export default function CategorySpotlightSection({
    ...
    return (
        <section className="py-20 md:py-32 bg-[#fcfaf8] border-t border-[#e6dad1]/30 overflow-hidden">
            <div className="max-w-[1400px] mx-auto px-6 grid md:grid-cols-2 gap-12 md:gap-24 items-center">

                {/* Columna Izquierda: Imagen (Entra desde la izquierda) */}
                ...
                {/* Columna Derecha: Textos (Entran en cascada desde abajo) */}
