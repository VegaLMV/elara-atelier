                ...
                <div className="space-y-12 text-[#3f2f2f]/80 leading-relaxed font-light">
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <ul className="list-none pl-2 space-y-2">
                                        ...
                                        <li className="relative pl-6">
                                            <span className="absolute left-0 top-2 w-1.5 h-1.5 bg-[#e6dad1] rounded-full" />
                                            La prenda debe estar SIN USO, sin olores, sin manchas, con sus etiquetas originales y en perfecto estado.
                                        </li>
                                    </ul>
                                </div>
                                <div>
                    ...
                    <ScrollReveal direction="up" delay={0.1}>
                        <section>
                            ...
                            <p>Sus datos personales son utilizados únicamente para procesar y entregar su pedido. No compartimos su información con terceros salvo con la empresa de mensajería para fines logísticos.</p>
                        </section>
                    </ScrollReveal>
