...
import { ArrowLeft, Printer, FileText, Calendar, Box, Truck } from "lucide-react";
  ...
  return (
    <div className="p-6 md:p-8 max-w-5xl mx-auto space-y-8 bg-gray-50 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-gray-200 pb-6">
        ...
        <button className="flex items-center gap-2 bg-white border border-gray-200 text-slate-700 px-4 py-2.5 rounded-xl text-sm font-bold hover:bg-gray-50 transition-all shadow-sm">
                    ...
                    return (
                        <tr key={it.id} className="hover:bg-gray-50 transition-colors group">
                            ...
                            <td className="px-6 py-4 text-center">
                                {hexColor ? (
                                    <span className="w-4 h-4 rounded-full border border-gray-300 shadow-sm inline-block" style={{ backgroundColor: hexColor }} title={it.variante?.color.nombre}></span>
