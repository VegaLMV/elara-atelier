            ...
            <tbody className="divide-y divide-gray-100">
                ...
                <tr key={p.id} className="hover:bg-gray-50 transition-colors group">
                    <td className="px-6 py-4">
                        ...
                        {p.correo && <div className="text-xs text-blue-600 mt-0.5">{p.correo}</div>}
                    </td>
                    <td className="px-6 py-4 font-mono text-gray-600 bg-gray-50/50 w-32">
                        {p.ruc ? <span className="bg-gray-100 px-2 py-1 rounded text-xs border">{p.ruc}</span> : <span className="text-gray-400">—</span>}
                    </td>
                    <td className="px-6 py-4 text-gray-600">
                        ...
                        ) : <span className="text-gray-400 opacity-50">Sin teléfono</span>}
                    </td>
                    <td className="px-6 py-4 text-gray-500 max-w-xs truncate" title={p.direccion ?? ""}>
                        {p.direccion ?? <span className="opacity-50">—</span>}
                    </td>
