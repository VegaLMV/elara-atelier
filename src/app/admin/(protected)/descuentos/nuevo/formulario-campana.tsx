               ...
               <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
                  ...
                  <div className="pt-2">
                     ...
                     <p className="text-[10px] text-gray-400 mt-2 px-1">
                        Esta imagen se usará en las secciones de publicidad del catálogo.
                     </p>
                  </div>
               </div>

               {/* Card: Reglas de Precio */}
                              ...
                              productosVisibles.map(p => {
                                 ...
                                 return (
                                    <div
                                       ...
                                       className={`relative group bg-white border rounded-xl overflow-hidden cursor-pointer transition-all duration-200 select-none ${isActive
